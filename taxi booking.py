...
c.execute('''CREATE TABLE IF NOT EXISTS receiptt (
    receiptt_id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    prime_sedan VARCHAR(255),
    premium_sedan VARCHAR(255),
    paid VARCHAR(255),
...
class travel:
    ...
    def __init__(self,root):
        self.root = root
        self.root.title("Taxi Booking System In SAKET")
        ...
        def Receiptt():
            if reset_counter == 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Email.get()!="":
                ...
                with sqlite3.connect('Users.db') as db:
                    ...
                    insert = '''INSERT INTO receiptt(
                    receipt_ref, date, taxi_no, firstname, surname, address, postal_code, mobile, email, ffrom, tto, pooling, standard, prime_sedan,
                    premium_sedan, paid, subtotal, totalcost
                    ) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'''

                    c.execute(insert, [
                        Receipt_Ref.get(), DateofOrder.get(), 'TR ' + Receipt_Ref.get() + ' BW',
                        Firstname.get(), Surname.get(), Address.get(), Postcode.get(),  Mobile.get(), Email.get(), varl1.get(), varl2.get(), 
                        varl3.get(), Standard.get(), PrimeSedan.get(), PremiumSedan.get(), 
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "CampusCafe":
                    switch ={"BoysHostel": 10,"GirlsHostel": 8,"AdmissionBlock":6,"CampusCafe": 0,"saket collage":2,"kalayan station ":10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "BoysHostel":
                    switch ={"BoysHostel": 0,"GirlsHostel": 2,"AdmissionBlock":5,"CampusCafe": 10,"saket collage":3,"kalayan station ":9}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "GirlsHostel":
                    switch ={"BoysHostel": 2,"GirlsHostel": 0,"AdmissionBlock":3,"CampusCafe": 8,"saket collage":1,"kalayan station ":7}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "AdmissionBlock":
                    switch ={"BoysHostel": 5,"GirlsHostel": 3,"AdmissionBlock":0,"CampusCafe": 6,"saket collage":0,"kalayan station ":8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "kalayan station ":
                    switch ={"BoysHostel": 10,"GirlsHostel": 8,"AdmissionBlock":6,"CampusCafe": 0,"saket collage":10,"kalayan station ":10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "saket collage":
                    switch ={"BoysHostel": 10,"GirlsHostel": 8,"AdmissionBlock":6,"CampusCafe": 0,"saket collage":0,"kalayan station ":10}
                    Km.set(switch[varl2.get()])
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('arial',70,'bold'),text=" Taxi Booking System in SAKET ")
        self.lblTitle.grid()
    ...
    #===============================================Taxi Information==============================================================
        ...
        self.cboPickup['value']=('kalayan station ','CampusCafe','AdmissionBlock','GirlsHostel','BoysHostel')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('Saket collage ','BoysHostel','GirlsHostel','CampusCafe','AdmissionBlock')
        self.cboDrop.current(0)
